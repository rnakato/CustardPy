...
The input FASTQ files can be gzipped (.fastq.gz).
Like ``custardpy_juicer``, ``custardpy_cooler_HiC`` processes all directories in <fastqdir>.
...
.. code-block:: bash
  ...
  custardpy_cooler_HiC [options] -i <index> -g <gt> -f <genome> <fastqdir>
...
- Output
    ...
    - hic/contact_map.q30.hic ... .hic file converted from .cool file
