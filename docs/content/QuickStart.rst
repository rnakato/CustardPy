...
- ``custardpy_process_cool``
    - The ``Eigen/`` directory contains the eigenvectors and compartment structures for each chromosome.
    - The ``InsulationScore/`` directory contains the insulation scores and TAD structures for each chromosome.
    - The ``Matrix/`` directory contains the normalized contact matrices.
