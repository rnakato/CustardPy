...
### 3.6.0 (2026.9.19)
- Added [ChIA-PIPE](https://github.com/TheJacksonLaboratory/ChIA-PIPE)
- Removed ChIAPoP
...
- Changed the filename of the multi-resolution .cool file generated by ``custardpy_cooler`` from ``*.multires.cool`` to ``*.mcool``.
